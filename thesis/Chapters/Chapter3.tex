...
Notes:
XClarity Controller -> BMC Configuration -> Service Enablement and Port Assignment -> IPMI over LAN
also check networ
https://160.85.30.101/redfish/v1/

ACPI and RAPL is working
kubectl logs -n kepler daemonset/kepler
