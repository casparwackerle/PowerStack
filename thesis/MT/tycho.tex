...
\thesistitle{Tycho:\\[0.5em]An Accuracy-First Architecture for Server-Wide Energy Measurement and Workload-Level Attribution in Kubernetes}              % Thesis title,              command: \ttitle
\newcommand{\imprintthesistitle}{Tycho: An Accuracy-First Architecture for Server-Wide Energy Measurement and Workload-Level Attribution in Kubernetes}
