...
Under background system load, the overall variance of the attributed dynamic power increases, but the qualitative separation between workloads persists.

\paragraph{Interpretation}
The observed behavior indicates that Tycho preserves workload-specific \emph{dynamic} energy attribution characteristics under concurrent execution.
