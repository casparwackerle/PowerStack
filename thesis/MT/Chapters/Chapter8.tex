...
interfaces, most notably \emph{Redfish}, which typically exhibits coarse temporal
resolution and non-negligible, variable reporting delay. While such interfaces
were intentionally used in this thesis to ensure broad deployability without
hardware modifications, future research could explore the integration of
