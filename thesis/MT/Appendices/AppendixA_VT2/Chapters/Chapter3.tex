...
\label{vt2_sec:linux-multitasking}
...
\label{vt2_sec:utilization_tracking}
...
\begin{table}[h]
    ...
    \label{vt2_tab:resource-tracking-comparison}
\end{table}

\subsection{Temporal Granularity and Measurement Resolution}
\label{vt2_sec:granularity}
...
\label{vt2_sec:cpu-metric-challenges}
...
\label{vt2_sec:attribution-philosophies}
...
\label{vt2_sec:container-centric}
...
\subsection{Distinction Between CPU Idling and Process Idling}
