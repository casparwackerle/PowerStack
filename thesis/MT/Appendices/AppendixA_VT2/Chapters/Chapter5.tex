...
While the thesis proposes concrete recommendations for future tool design (see \S~\ref{vt2_sec:future-tools}), it deliberately refrains from developing a full tool architecture or implementation. Instead, the findings are intended to inform such efforts in future research, particularly within the scope of the author’s upcoming master's thesis.
