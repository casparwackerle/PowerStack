...
While the thesis proposes concrete recommendations for future tool design (see Section~\ref{vt2_sec:future-tools}), it deliberately refrains from developing a full tool architecture or implementation. Instead, the findings are intended to inform such efforts in future research, particularly within the scope of the author’s upcoming master's thesis.
...
\label{vt2_sec:future-tools}

\subsection{Towards Maximum-Accuracy Measurement Tools}
\label{vt2_sec:future-maximum-accuracy}
...
\label{vt2_sec:future-missing-domains}
...
\label{vt2_sec:future-accuracy-overhead}
...
\label{vt2_sec:future-user-roles}
...
\label{vt2_sec:future-virtualized-environments}
...
\label{vt2_sec:future-standardization}
...
\label{vt2_sec:future-research-industry}
...
\label{vt2_sec:future-conclusion}
