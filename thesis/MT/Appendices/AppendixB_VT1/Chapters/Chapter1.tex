\section{Introduction and Context} % Main chapter title
\label{Chapter1}
\docseparator{Appendix B}
...
During the writing of this thesis, \textit{ChatGPT}\parencite{OpenAI_ChatGPT_2025} (Version 4, OpenAI, 2024) was used as an auxiliary tool to enhance efficiency in documentation and technical writing. Specifically, it assisted in:
\begin{itemize}
