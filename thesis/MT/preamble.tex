...
\newcommand{\appchapterref}[2]{%
  \hyperref[#2]{Appendix~#1, Chapter~\ref*{#2}}%
}
...
\newcommand{\docseparator}[1]{%
  % List of Figures
  \addtocontents{lof}{\protect\addvspace{1.5\baselineskip}}%
  \addcontentsline{lof}{section}{#1}%
  % List of Tables
  \addtocontents{lot}{\protect\addvspace{1.5\baselineskip}}%
...
\defbibheading{bibintocunnum}[\bibname]{%
  \cleardoublepage
  \phantomsection
  \addcontentsline{toc}{part}{#1}% or {chapter} if you prefer
  \chapter*{#1}%
}
