...
\thesistitle{Title}             % Thesis title,              command: \ttitle
...
\include{Chapters/WIP/development-environment}
\include{Chapters/WIP/eBPF-implementation}
\include{Chapters/WIP/GPU-implementation}
\include{Chapters/WIP/redfish-implementation}
\include{Chapters/WIP/configuration_implentation}
\include{Chapters/WIP/timing-engine}
...
%\include{Appendices/AppendixA}  %wrapper for VT2
%\include{Appendices/AppendixB} %wrapper for VT1
%\include{Appendices/AppendixB}
%\include{Appendices/AppendixC}
%\include{Appendices/DeclarationOfOriginalityZHAW} 

% {\small
% \part*{Appendix A:\\Container-Level Energy Consumption Estimation:\\Foundations, Challenges, and Current Approaches}
% }
% \addcontentsline{toc}{part}{Appendix A:\\Container-Level Energy Consumption Estimation:\\Foundations, Challenges, and Current Approaches}
% \setcounter{chapter}{0}
% \include{Appendices/AppendixA_VT2/main}


\cleardoublepage
\thispagestyle{plain} % or empty, if you prefer
...
\begin{center}
{\Large Appendix A}\\[1em] % <-- control size here
...
% \cleardoublepage
% \part*{Appendix B: Powerstack: Implementation of an energy monitoring environment in Kubernetes}
% \addcontentsline{toc}{part}{Appendix B: Powerstack: Implementation of an energy monitoring environment in Kubernetes}
% \setcounter{chapter}{0}
% \include{Appendices/AppendixB_VT1/main}
