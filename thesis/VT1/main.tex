...
\thesistitle{Powerstack: Implementation of an energy monitoring environment in Kubernetes}             % Thesis title,              command: \ttitle
\thesistype{Specialization Project 1}             % Type of thesis (e.g. Master Thesis) \ttype
\thesisdate{January 31, 2025}                     % Date of submission                  \tdate
