...
LOG_FILE="$REPO_PATH/logs/installation_rancher_$TIMESTAMP.log"
...
cd "$REPO_PATH/ansible/rancher-ansible" || { echo "Error: 'ansible' directory not found in $REPO_PATH"; exit 1; }
