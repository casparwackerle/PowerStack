...
LOG_FILE="$REPO_PATH/logs/removal_kepler_$TIMESTAMP.log"
...
ansible-playbook playbooks/remove-kepler.yml -i inventory.yml -i ../../configs/inventory.yml
echo "kepler removal complete!"
