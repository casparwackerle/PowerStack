...
LOG_FILE="$REPO_PATH/logs/installation_tycho_$TIMESTAMP.log"
...
ansible-playbook playbooks/deploy-tycho.yml -i ../../configs/inventory.yml  --ask-vault-pass
echo "tycho installation complete!"
